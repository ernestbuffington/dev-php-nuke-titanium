...
--
-- Table structure for table `nuke_fbmessages`
--

CREATE TABLE `nuke_fbmessages` (
  `id` mediumint(8) UNSIGNED NOT NULL,
  `user_to` varchar(60) COLLATE utf8_bin NOT NULL DEFAULT '',
  `user_from` varchar(60) COLLATE utf8_bin NOT NULL DEFAULT '',
  `msg_body` text COLLATE utf8_bin DEFAULT NULL,
...
--
-- Table structure for table `nuke_fbposts`
--

CREATE TABLE `nuke_fbposts` (
  `post_id` mediumint(8) UNSIGNED NOT NULL,
  `user_id` mediumint(8) UNSIGNED NOT NULL DEFAULT 0,
  `post_content` text COLLATE utf8_bin DEFAULT NULL,
  `upload_image` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
  `post_date` varchar(20) COLLATE utf8_bin NOT NULL DEFAULT ''
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- --------------------------------------------------------

--
-- Table structure for table `nuke_fbcomments`
--

CREATE TABLE `nuke_fbcomments` (
  `com_id` mediumint(8) UNSIGNED NOT NULL,
  `post_id` mediumint(8) UNSIGNED NOT NULL DEFAULT 0,
  `user_id` mediumint(8) UNSIGNED NOT NULL DEFAULT 0,
  `comment` text COLLATE utf8_bin DEFAULT NULL,
  `comment_author` varchar(60) COLLATE utf8_bin NOT NULL DEFAULT '',
...
CREATE TABLE `nuke_users` (
  ...
  `f_name` varchar(25) COLLATE utf8_bin NOT NULL DEFAULT '',
  `l_name` varchar(25) COLLATE utf8_bin NOT NULL DEFAULT '',
  `user_name` varchar(25) COLLATE utf8_bin NOT NULL DEFAULT '',
  `describe_user` longtext COLLATE utf8_bin DEFAULT NULL,
  `Relationship` varchar(25) COLLATE utf8_bin NOT NULL DEFAULT '',
  `user_pass` varchar(40) COLLATE utf8_bin NOT NULL DEFAULT '',
  `user_country` varchar(40) COLLATE utf8_bin NOT NULL DEFAULT '',
  `user_email` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
  `femail` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
  `user_website` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
  `user_avatar` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
  `user_image` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
  `user_cover` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
  `user_regdate` varchar(20) COLLATE utf8_bin NOT NULL DEFAULT '',
  `user_reg_date` varchar(20) COLLATE utf8_bin NOT NULL DEFAULT '',
  `status` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `posts` smallint(5) UNSIGNED NOT NULL DEFAULT 0,
  `recovery_account` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
  `user_birthday_nuke` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `user_from_flag` varchar(64) COLLATE utf8_bin DEFAULT NULL,
  `user_interests` varchar(150) COLLATE utf8_bin NOT NULL DEFAULT '',
  ...
  `user_sig` text COLLATE utf8_bin DEFAULT NULL,
  ...
  `umode` varchar(10) COLLATE utf8_bin NOT NULL DEFAULT '',
  `uorder` tinyint(1) NOT NULL DEFAULT 0,
  `thold` tinyint(1) NOT NULL DEFAULT 0,
  `noscore` tinyint(1) NOT NULL DEFAULT 0,
  `bio` longtext COLLATE utf8_bin DEFAULT NULL,
  `ublockon` tinyint(1) NOT NULL DEFAULT 0,
  `ublock` tinytext COLLATE utf8_bin DEFAULT NULL,
  ...
  `user_lang` varchar(30) COLLATE utf8_bin NOT NULL DEFAULT 'english',
  ...
  `user_color_gc` varchar(6) COLLATE utf8_bin DEFAULT '',
  `user_color_gi` text COLLATE utf8_bin DEFAULT NULL,
  ...
  `user_pc_timeOffsets` varchar(55) COLLATE utf8_bin NOT NULL DEFAULT '0',
  `user_view_log` tinyint(4) NOT NULL DEFAULT 0,
  `user_glance_show` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '1',
  ...
  `xdata_bbcode` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  ...
  `user_admin_notes` text COLLATE utf8_bin DEFAULT NULL,
  `user_allow_arcadepm` tinyint(4) NOT NULL DEFAULT 0
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

INSERT INTO `nuke_users` (`user_id`, `user_status`, `name`, `username`, `f_name`, `l_name`, `user_name`, `describe_user`, `Relationship`, `user_pass`, `user_country`, `user_email`, `femail`, `user_website`, `user_avatar`, `user_image`, `user_cover`, `user_regdate`, `user_reg_date`, `status`, `posts`, `recovery_account`, `user_birthday_nuke`, `user_realname`, `user_occ`, `user_from`, `user_from_flag`, `user_interests`, `user_femail`, `user_newsletter`, `user_points`, `check_num`, `user_sig`, `user_address`, `user_viewemail`, `user_theme`, `user_facebook`, `user_password`, `password_reset`, `user_ip`, `storynum`, `umode`, `uorder`, `thold`, `noscore`, `bio`, `ublockon`, `ublock`, `theme`, `commentmax`, `counter`, `newsletter`, `user_posts`, `user_attachsig`, `user_rank`, `user_level`, `broadcast`, `popmeson`, `user_active`, `user_session_time`, `user_session_page`, `user_lastvisit`, `user_lastpage`, `user_login_attempts`, `user_login_block_expire`, `user_inactive_reason`, `user_inactive_time`, `user_timezone`, `user_style`, `user_lang`, `user_dateformat`, `user_new_privmsg`, `user_unread_privmsg`, `user_last_privmsg`, `user_emailtime`, `user_allowhtml`, `user_allowbbcode`, `user_allowsmile`, `user_allowavatar`, `user_allow_pm`, `user_allow_mass_pm`, `user_allow_viewonline`, `user_notify`, `user_notify_pm`, `user_popup_pm`, `user_avatar_type`, `user_sig_bbcode_uid`, `user_actkey`, `user_newpasswd`, `points`, `last_ip`, `user_wordwrap`, `agreedtos`, `user_allowsignature`, `user_report_optout`, `user_show_quickreply`, `user_quickreply_mode`, `user_color_gc`, `user_color_gi`, `user_showavatars`, `user_showsignatures`, `user_time_mode`, `user_dst_time_lag`, `user_pc_timeOffsets`, `user_view_log`, `user_glance_show`, `user_hide_images`, `user_open_quickreply`, `sceditor_in_source`, `xdata_bbcode`, `user_ftr`, `user_ftr_time`, `user_rank2`, `user_rank3`, `user_rank4`, `user_rank5`, `user_gender`, `user_about`, `user_birthday`, `user_birthday2`, `birthday_display`, `birthday_greeting`, `user_next_birthday`, `user_reputation`, `user_rep_last_time`, `user_admin_notes`, `user_allow_arcadepm`) VALUES ('1', '1', 'Anonymous', 'Anonymous', 'Anonymous', 'Anonymous', 'Anonymous', NULL, '', '', '', '', '', '', 'blank.png', 'blank.png', 'cover.png', 'Oct 13, 2022', 'Oct 13, 2022', NULL, '0', '', NULL, NULL, NULL, NULL, NULL, '', NULL, '0', '0', NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, '10', '', '0', '0', '0', NULL, '0', NULL, '', '4096', '0', '0', '0', '1', '0', '1', '1', '0', '1', '0', '0', '0', NULL, '0', NULL, '0', '0', '0.00', NULL, 'english', 'D M d, Y g:i a', '0', '0', '0', NULL, '1', '1', '1', '1', '1', '4', '1', '0', '1', '1', '3', NULL, NULL, NULL, '0', '0', '70', '0', '1', '0', '1', '1', '', NULL, '1', '1', '6', '60', '0', '0', '1', '0', '1', '0', NULL, '0', '0', '-1', '-2', '-2', '-2', '0', NULL, '0', NULL, '0', '0', '0', '0', NULL, NULL, '0');
